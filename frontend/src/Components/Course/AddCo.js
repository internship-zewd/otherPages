                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="user-details">
                                 ...
                                 <div className="input-box">
                                    ...
                                    <input type="text"  id='courseName' required value={courseName} onChange={(e) =>{ setCoursename(e.target.value) }} name="courseName" placeholder="Enter Name of course" /><br />
                                    <div className="errors">{errors.courseName}<br/></div>
                               ...
                               <div className="input-box">
                                    <span className="details">Tuition Fee</span>
                                     <input type='number' id='fee' required value={fee} onChange={(e) => { setFee(e.target.value) }} name='fee' placeholder='Enter tuition fee'  /><br />
                                     <div className="errors">{errors.fee}</div>
                                </div>

                                <div className="input-box">
                                    <span className="details">Expected Duration in Days</span>
                                    <input type='number' id='duration' required value={duration} onChange={(e) => { setDuration(e.target.value) }} name='duration' placeholder='Enter duration' /><br />
